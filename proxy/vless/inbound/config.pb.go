...
type Config struct {
	...
	ExtAuth       *extauth.Config        `protobuf:"bytes,8,opt,name=extAuth,proto3" json:"extAuth,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Config) GetExtAuth() *extauth.Config {
	if x != nil {
		return x.ExtAuth
	}
	return nil
...
const file_proxy_vless_inbound_config_proto_rawDesc = "" +
	"\n" +
	" proxy/vless/inbound/config.proto\x12\x18xray.proxy.vless.inbound\x1a\x1acommon/protocol/user.proto\x1a\x18app/extauth/config.proto\"\x82\x01\n" +
	"\bFallback\x12\x12\n" +
	...
	"\x04xver\x18\x06 \x01(\x04R\x04xver\"\xca\x02\n" +
	"\x06Config\x124\n" +
	...
	"\apadding\x18\a \x01(\tR\apadding\x122\n" +
	"\aextAuth\x18\b \x01(\v2\x18.xray.app.extauth.ConfigR\aextAuthBj\n" +
...
var file_proxy_vless_inbound_config_proto_goTypes = []any{
	...
	(*extauth.Config)(nil), // 3: xray.app.extauth.Config
}
var file_proxy_vless_inbound_config_proto_depIdxs = []int32{
	...
	3, // 2: xray.proxy.vless.inbound.Config.extAuth:type_name -> xray.app.extauth.Config
